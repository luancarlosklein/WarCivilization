...
class PlayerInfoSelector(menu.Menu):
   def __init__(self, backImage = "none", soundBack = "none", soundEff = "none", volBack = 0, volEff = 0, ratioE = 1):
      ...
      self.buttons.append(button.Button(os.path.join("images", "selectionMenu", "civilizations", "SovietUnion.png"), (1560, 400), 121, 83, "SovietUnion", "button", ratioE))
      self.buttons.append(button.Button(os.path.join("images", "selectionMenu", "civilizations", "GreatBritain.png"), (240, 370), 134, 116, "GreatBritain", "button", ratioE))
